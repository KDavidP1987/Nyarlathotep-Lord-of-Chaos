...
/// location spawns around the admin who started the event. Units live until the event's end + GraceSeconds, or their
/// own unitLifetimeSeconds when shorter (Business rules 2).
/// </summary>
