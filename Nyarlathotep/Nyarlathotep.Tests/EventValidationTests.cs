...
public partial class EventValidationTests
{
    ...
    [InlineData("\"announce\": { \"start\": [\"<color=red>hi</color>\"] }", "announce.start must be 0-5 lines of 1-200 characters, no angle brackets or control characters")]
    [InlineData("\"announce\": { \"start\": [\"a\",\"b\",\"c\",\"d\",\"e\",\"f\"] }", "announce.start must be 0-5 lines of 1-200 characters, no angle brackets or control characters")]
    ...
    [InlineData("{ \"id\": \"raid\", \"name\": \"\" }", "raid", "name must be 1-40 characters, no angle brackets or control characters")]
