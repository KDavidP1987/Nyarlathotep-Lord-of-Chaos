...
6 plan(s) · 2 open · 3 done · prediction rate across done plans 59 % (80 baseline items / 55 discovered design changes; target ≥ 90 %)

| Plan | Title | Status | Size | Verified | Baseline items | Prediction | Parent |
|---|---|---|---|---|---|---|---|
| [event-library](event-library.md) | Event library — built-in templates and in-game authoring | draft | L | 0/34 | — | — | nyarlathotep |
