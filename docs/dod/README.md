...
4 plan(s) · 1 open · 2 done · prediction rate across done plans 58 % (58 baseline items / 42 discovered design changes; target ≥ 90 %)
...
| [raphael-api-core](raphael-api-core.md) | Raphael api 2 — status, events, push subscription, paging, contract check | draft | L | 0/20 | — | — | nyarlathotep |
