...
3 plan(s) · 1 open · 1 done · prediction rate across done plans 50 % (20 baseline items / 20 discovered design changes; target ≥ 90 %)

| Plan | Title | Status | Size | Verified | Baseline items | Prediction | Parent |
|---|---|---|---|---|---|---|---|
| [foundation](foundation.md) | Foundation engine, store, spawner, scheduler, announcer and commands | draft | L | 0/38 | — | — | nyarlathotep |
